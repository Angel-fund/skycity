...
(function($) {
    ...
    $.Autocompleter = function($elem, options) {
         ...
         */
         ...
         //    var temp =  $('autoInput').attr('value');
         //    temp = temp.split('@');
         //    var tmp = (window.location.href).split('enterprise');            
         //    if(e.keyCode == 13)
         //    {
         //    var url = tmp[0]+'enterprise/inspection?id='+temp[1];
         //    window.location.href = url;
         //    }  
         // });

        // $elem.keydown(function(e) {
        // jason edit,fix for ff
    ...
    $.Autocompleter.prototype.selectItem = function($li) {
        ...
        this.callHook('onItemSelect', { value: value, data: data, dom: this.dom.$elem });
